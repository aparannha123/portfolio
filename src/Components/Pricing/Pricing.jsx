    ...
    <section className="pricing container section">
      ...
      <div className="pricing__container grid">
        <div className="pricing__item">
          ...
          <p className="pricing__title">A Simple option but powerful to 
          manage your business</p>
          <p className="pricing__support">Email support</p>
          <h3 className="price">
            <em>₹</em> 9000 <span>Month</span>
          </h3>
        ...
        <div className="pricing__item best">
          ...
          <p className="pricing__title">Unlimited product including projects
          and more features</p>
          <p className="pricing__support">Mon-Fri support</p>
          <h3 className="price">
            <em>₹</em> 15000 <span>Month</span>
          </h3>
          <a href="" className='btn'>Get Started</a>
        </div>
        ...
        <div className="pricing__item">
          ...
          <p className="pricing__title">A wise option for large
          companies and individuals</p>
          <p className="pricing__support">24/7 support</p>
          <h3 className="price">
            <em>₹</em> 20000 <span>Month</span>
          </h3>
          <a href="" className='btn'>Get Started</a>
        </div>
      </div>
